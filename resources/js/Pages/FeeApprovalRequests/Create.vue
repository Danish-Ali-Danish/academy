    ...
    <div class="min-h-screen flex flex-col">
      <div class="flex-1 px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Create Approval Request</h1>
            <p class="mt-2 text-sm text-gray-600">Track fee waivers, refunds, fine waivers, concessions, and voucher edit approvals.</p>
          </div>
...
const submit = () => form.post(route('fee-approval-requests.store'), { preserveScroll: true })
</script>
