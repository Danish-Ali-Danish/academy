        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p class="mt-2 text-sm text-slate-600 flex items-center gap-2">
              ...
              Update grading scale configuration
            </p>
          </div>
...
const props = defineProps({
  gradeScale: { type: Object, required: true },
  branches: { type: Array, default: () => [] }
})

const form = useForm({
  branch_id: props.gradeScale.branch_id || '',
  name: props.gradeScale.name,
  min_percentage: props.gradeScale.min_percentage,
  max_percentage: props.gradeScale.max_percentage,
  grade: props.gradeScale.grade,
  grade_point: props.gradeScale.grade_point,
  remarks: props.gradeScale.remarks || '',
  status: props.gradeScale.status
})
...
const submit = () => {
  form.put(route('grade-scales.update', props.gradeScale.id), {
    preserveScroll: true,
    onSuccess: () => {
