          ...
          <form @submit.prevent="submit">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <select id="student_enrollment_id" v-model="form.student_enrollment_id" :disabled="!selectedStudentId || loadingEnrollments" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed" required>
              ...
              <div>
                ...
                <select id="concession_type_id" v-model="form.concession_type_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
...
const submit = () => {
  form.put(route('student-fee-concessions.update', props.concession.id), { preserveScroll: true })
}
</script>
