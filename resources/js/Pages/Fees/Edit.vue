    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Fee Record</h1>
            <p class="mt-2 text-sm text-gray-600">Update fee record information and details</p>
          </div>
        ...
        <form @submit.prevent="submit">
                ...
                <div class="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <p class="text-lg font-semibold text-red-700">
                      Rs. {{ (calculateNetAmount() - Number(fee.paid_amount || 0)).toLocaleString() }}
                    </p>
                  </div>
                  <div>
          ...
          <div class="px-8 py-6 bg-gray-50 border-t border-gray-200">
            <div class="flex justify-end gap-3">
              ...
              >
                <span v-if="!form.processing">Update Fee Record</span>
...
const form = useForm({
  ...
  fee_type_id: props.fee.fee_type_id,
  class_id: props.fee.class_id,
  branch_id: props.fee.branch_id,
  month: props.fee.month,
  year: props.fee.year,
  academic_year: props.fee.academic_year,
  total_amount: props.fee.total_amount,
  discount_percent: props.fee.discount_percent,
  discount_amount: props.fee.discount_amount,
  discount_reason: props.fee.discount_reason,
  fine_amount: props.fee.fine_amount,
...
const onStudentChange = () => {
  ...
  if (student) {
    form.class_id = student.class_id || form.class_id
    form.branch_id = student.branch_id || form.branch_id
  }
}
