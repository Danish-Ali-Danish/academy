        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p class="mt-2 text-sm text-slate-600 flex items-center gap-2">
              ...
              Configure subjects and their schedules {{ exam ? 'for ' + exam.name : '' }}
            </p>
          </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
          ...
          <div class="p-6 sm:p-8 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-transparent">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-semibold text-slate-900">Schedule Subjects ({{ subjects.length }})</h2>
              </div>
              <Button 
                @click="addSubject" 
                variant="primary"
          ...
          <div class="p-6 sm:p-8">
            <div v-if="subjects.length === 0" class="text-center py-12">
              ...
              <p class="mt-2 text-sm font-medium text-slate-500">No subjects added yet</p>
              ...
              >
                <div class="flex items-start justify-between mb-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <h3 class="font-semibold text-slate-900">Subject {{ index + 1 }}</h3>
...
const submit = () => {
  ...
  router.post(route('exam-subjects.store', props.exam.id), {
